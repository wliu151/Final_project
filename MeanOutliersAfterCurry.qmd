...
veterans_least_3pt_percentage <- veterans[veterans$X3_point_percentage < lower_bound, ]
veterans_least_3pt_percentage <- veterans_least_3pt_percentage[!is.na(veterans_least_3pt_percentage$X3_point_percentage), ]

veterans_least_3pt_percentage
```
